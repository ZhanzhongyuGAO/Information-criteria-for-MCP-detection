"""modified pelt with adjustable penalty"""
...
class Pelt(BaseEstimator):
    ...
    def __init__(self, model="l2", custom_cost=None, min_size=2, jump=5, para_nums=1, params=None):
    ...
    def _seg(self, pen):
        ...
        for bkp in ind:
            ...
            for t in admissible:
                ...
                pen = self.cost.pen_term(self.para_nums, pen_name, t, bkp, list(tmp_partition.keys()))
